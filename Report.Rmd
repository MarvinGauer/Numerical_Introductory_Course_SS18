...
When numerically solving an integral one is naturally interested in the error of the approximation which will in the following be denoted by $\varepsilon$.
